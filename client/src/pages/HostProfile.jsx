...
const HostProfile = () => {
  ...
  const averageRating =
    hostProperties.length > 0
      ? (
          hostProperties.reduce((sum, prop) => sum + (prop.rating || 0), 0) / hostProperties.length
        ).toFixed(1)
                        ...
                        <div className="p-4 bg-gradient-to-r from-yellow-50 to-amber-50 rounded-lg border border-yellow-200">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                Top-rated host with exceptional reviews
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                Identity and contact information confirmed
                              </p>
                            </div>
                          </div>
                        </div>
                            ...
                            <Link to={`/properties/${property._id}`} className="block">
                              ...
                              <div className="p-4">
                                ...
                                <div className="flex items-center text-sm text-gray-600 mb-3">
                                  ...
                                  <span>
                                    {property.city || 'Karachi'}, {property.state || 'Sindh'}
                                  </span>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="text-right">
                                    <span className="text-lg font-bold text-gray-900">
                                      Rs {(property.price || 15000).toLocaleString()}
                                    </span>
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div className="prose max-w-none">
                      <p className="text-gray-700 leading-relaxed text-base mb-6">
                        {host.bio ||
                          `Welcome! I'm ${host.fullName}, a dedicated host on Rentifi with a passion for providing exceptional hospitality. I believe that every guest deserves a comfortable, clean, and memorable stay. With ${totalProperties} ${totalProperties === 1 ? 'property' : 'properties'} under my care, I'm committed to ensuring your experience exceeds your expectations.`}
                      </p>

                      <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                        <h4 className="font-semibold text-blue-900 mb-2">My Hosting Philosophy</h4>
                        <p className="text-blue-800 text-sm">
                          "I treat every guest like family and every property like my own home.
                          Clear communication, attention to detail, and genuine care for my guests'
                          comfort are the pillars of my hosting approach."
                        </p>
                      </div>
