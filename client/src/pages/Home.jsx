...
const Hero = () => {
  ...
  return <div className="relative min-h-[85vh] overflow-hidden bg-white dark:bg-gray-900">
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-light-beige/40 to-white dark:from-gray-800/40 dark:to-gray-900"></div>
      ...
      <div className="relative page-container z-10 flex flex-col lg:flex-row items-center pt-32 pb-20">
        ...
        ease: "easeOut"
          ...
          <h1 className="text-5xl sm:text-6xl font-display font-bold leading-tight mb-6 text-gray-900 dark:text-gray-100">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/30 p-4 mb-8 relative z-20 max-w-2xl">
            <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                  <MapPin size={20} className="text-earth-brown" />
                </div>
                <input type="text" placeholder="Where are you going?" className="w-full pl-12 pr-4 py-4 border border-cream-beige dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 focus:ring-2 focus:ring-earth-brown/20 focus:border-earth-brown outline-none" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} />
              </div>
              ...
              <div className="flex-1 relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 border border-cream-beige dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 focus:ring-2 focus:ring-earth-brown/20 focus:border-earth-brown outline-none"
                  value={checkInDate}
            ...
            <div className="mt-4 flex flex-wrap gap-3 items-center px-2">
              ...
              {['Karachi', 'Lahore', 'Islamabad', 'Murree'].map(term => <Badge 
                key={term} 
                variant="outline" 
                className="bg-transparent border-cream-beige dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-cream-beige/10 dark:hover:bg-gray-700 cursor-pointer"
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map(i => <div key={i} className="w-10 h-10 rounded-full border-2 border-white dark:border-gray-700 overflow-hidden">
            ...
            <div>
              <div className="flex items-center text-amber-500 mb-1">
                ...
                <Star className="fill-amber-500 h-4 w-4" />
                <Star className="fill-amber-500 h-4 w-4" />
                <span className="ml-2 text-gray-800 dark:text-gray-200 font-medium">4.9</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">from over 20,000 happy travelers</p>
            </div>
          </div>
        </motion.div>
        ...
        delay: 0.2
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            {['Verified Hosts', 'Instant Booking', 'Free Cancellation'].map(feature => <Badge key={feature} className="bg-white dark:bg-gray-800 border border-cream-beige/60 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-1.5 px-3 shadow-sm">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120" className="w-full">
          <path className="fill-white dark:fill-gray-900" fillOpacity="1" d="M0,64L60,64C120,64,240,64,360,58.7C480,53,600,43,720,48C840,53,960,75,1080,80C1200,85,1320,75,1380,69.3L1440,64L1440,120L1380,120C1320,120,1200,120,1080,120C960,120,840,120,720,120C600,120,480,120,360,120C240,120,120,120,60,120L0,120Z"></path>
        </svg>
      </div>
    </div>;
};
  ...
  return <section className="py-16 bg-white dark:bg-gray-900">
      <div className="page-container">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10">
          <div>
            <Badge className="mb-2 bg-earth-brown/20 dark:bg-earth-brown/30 text-earth-brown hover:bg-earth-brown/30 dark:hover:bg-earth-brown/40 border-none">
              Featured
            </Badge>
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-gray-900 dark:text-gray-100 mb-2">
              Featured Properties
            </h2>
  ...
  return <section className="py-16 bg-white dark:bg-gray-900">
      <div className="page-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {destinations.map(destination => <Link key={destination.id} to={`/properties?city=${encodeURIComponent(destination.name)}`}>
